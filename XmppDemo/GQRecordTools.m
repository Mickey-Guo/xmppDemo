...
@implementation GQRecordTools

+ (instancetype)sharedRecorder {
    static GQRecordTools *instance;
...
- (instancetype)init
{
    ...
    if (self) {
        ...
        _recorder = [[AVAudioRecorder alloc]initWithURL:_recordURL settings:recordSettings error:nil];
        
        // 准备
        BOOL result = [_recorder prepareToRecord];
